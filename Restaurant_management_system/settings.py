...
ALLOWED_HOSTS = ['127.0.0.1', 'dave-restaurant.herokuapp.com']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'dawitnigus18@gmail.com'   # enter you email address
EMAIL_HOST_PASSWORD = 'ntyyjpagzhqazcyt'     # enter your password 
